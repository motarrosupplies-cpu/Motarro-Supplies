-- Ready-to-Ship Products Schema for Apparely.co.za
...
-- INSERT INTO ready_to_ship_products (name, slug, description, base_price, category, stock_quantity, is_gift_item, max_price_for_filter, primary_image) VALUES
-- ('Stainless Steel Tumbler 500ml', 'stainless-steel-tumbler-500ml', 'Premium double-wall insulated tumbler', 199.00, 'tumbler', 50, true, 199.00, '/images/tumbler.jpg'),
-- ('Canvas Tote Bag', 'canvas-tote-bag', 'Eco-friendly canvas tote with logo space', 89.00, 'tote', 100, true, 89.00, '/images/tote.jpg'),
-- ('Cork Coaster Set (4pc)', 'cork-coaster-set', 'Set of 4 natural cork coasters', 45.00, 'coaster', 200, true, 45.00, '/images/coasters.jpg'),
-- ('Custom Keychain', 'custom-keychain', 'Durable metal keychain with custom engraving', 35.00, 'keychain', 150, true, 35.00, '/images/keychain.jpg');
