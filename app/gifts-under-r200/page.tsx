...
export const metadata: Metadata = {
  title: "Gifts Under R200 | MOTARRO Supplies",
  description: "Shop affordable gifts under R200. Perfect for corporate gifting, event favours, and Christmas 2025. Stainless steel tumblers, canvas totes, coasters, keychains, and more. Same-day dispatch.",
  keywords: [
    "gifts under r200",
    "affordable corporate gifts",
    "cheap gifts johannesburg",
    "event favours under r200",
    "budget gifts",
    "corporate gift ideas",
    "christmas gifts under r200"
  ],
  alternates: {
    canonical: "/gifts-under-r200"
  }
}
...
export default async function GiftsUnderR200Page() {
  ...
  const { data: products, error } = await client
    ...
    .lte('max_price_for_filter', 200)
    .order('featured', { ascending: false })
    .order('base_price', { ascending: true })

  if (error) {
    console.error('Error fetching gifts under R200:', error)
  }
  ...
  }).filter((p: any) => p.currentPrice <= 200)
      ...
      <div className="container px-4 py-12 mx-auto max-w-7xl">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full mb-4">
            ...
            <span className="font-semibold">Affordable Gifts</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-black tracking-tight text-primary mb-4">
            Gifts Under R200
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-6">
            Perfect affordable gifts for corporate clients, event favours, and Christmas 2025. Premium quality items at budget-friendly prices. Same-day dispatch from Kempton Park.
          </p>
        </div>
        ...
        {processedProducts.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground mb-6">
              We're currently updating our gift selection. Check back soon!
            </p>
            <Button asChild>
        ...
        <div className="mt-12 text-center bg-primary/5 rounded-lg p-8">
          <h2 className="text-3xl font-black mb-4">Need Bulk Pricing?</h2>
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Ordering 10+ items? Contact us for special bulk pricing and custom branding options.
          </p>
          <div className="flex gap-4 justify-center">
            <Button asChild size="lg">
              <Link href="/corporate-gifts">View Corporate Gifts</Link>
            </Button>
        ...
        <div className="aspect-square relative bg-muted overflow-hidden">
          ...
          <div className="absolute top-2 left-2 flex flex-col gap-1">
            ...
            {product.currentPrice <= 200 && (
              <Badge className="bg-green-500 text-white">Under R200</Badge>
            )}
          </div>
        </div>
