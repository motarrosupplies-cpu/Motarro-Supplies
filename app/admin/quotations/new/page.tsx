...
import { Customer, CreateQuotationData, QuotationItem } from '@/types/invoice';
...
export default function NewQuotationPage() {
  ...
  const [formData, setFormData] = useState<CreateQuotationData>({
    ...
    notes: '',
    terms: 'This quotation is valid for 30 days from the issue date.',
    includeVat: false,
  });
  ...
  const totals = calculateDocumentTotals(
    ...
    hasDeliveryFee && formData.deliveryFee ? formData.deliveryFee : 0,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const quotation = await invoiceService.createQuotation(formData);
      toast({
        title: 'Success',
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Select customer and set quotation information</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Add products or services to this quotation</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Add a delivery fee to this quotation</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                <Label htmlFor="delivery-fee-toggle">Include Delivery Fee</Label>
                <p className="text-sm text-muted-foreground">
                  Toggle to add a delivery fee to this quotation
                </p>
              </div>
              <Switch
                ...
                onCheckedChange={(checked) => {
                  setHasDeliveryFee(checked);
                  if (!checked) {
                    handleInputChange('deliveryFee', undefined);
                  }
                }}
              />
            </div>
            {hasDeliveryFee && (
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Delivery fee is VAT-inclusive and will be added to the total
                </p>
              </div>
            )}
          </CardContent>
        ...
        <div className="flex justify-end gap-4">
          <Button variant="outline" asChild>
            <Link href="/admin/quotations">Cancel</Link>
          </Button>
