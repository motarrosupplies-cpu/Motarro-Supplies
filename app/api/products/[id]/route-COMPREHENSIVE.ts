...
export async function GET(
  ...
  try {
    ...
    const transformedProduct = {
      ...
      imageAltTexts: parseJsonField(product.image_alt_texts),
...
export async function PUT(
  ...
  try {
    ...
    const dbData = {
      ...
      seo_slug: validatedData.seoSlug,
    };
    ...
    return NextResponse.json({
      ...
      colors: parseJsonField(updatedProduct.colors),
      sizes: parseJsonField(updatedProduct.sizes),
      imageAltTexts: parseJsonField(updatedProduct.image_alt_texts),
